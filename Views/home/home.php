            ...
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival">GIÀY ĐÁ BÓNG <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#popular">GĂNG TAY THỦ MÔN <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#best">QUẦN ÁO BÓNG ĐÁ</a></li>
                        </ul>
                    </div>
                </div>
            </div>
